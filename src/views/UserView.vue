<template>
	<GridLayout rows="auto, *, auto">
		...
		<RadListView ref="list" for="shift in shifts" pullToRefresh="true" @pullToRefreshInitiated="getShifts" @itemTap="showShift($event.index)" selectionBehavior="longPress" multipleSelection="true" row="1">
			<v-template>
